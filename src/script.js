...
gltfLoader.load('/models/creative_text.glb', gltf => {
    ...
    const sphere = new THREE.Mesh( new THREE.SphereGeometry(3), new THREE.MeshBasicMaterial())
    sphere.rotateY(90)
    positions.push(sphere.geometry.getAttribute('position'))
    ...
    particles.colorA = '#d66ba4'
    particles.colorB = '#60a4d7'
    ...
    particles.points.frustumCulled = false // effect that hides elements that are not visible, but calculated from position and is not updated
